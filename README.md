...
ALERT - THERE SEEMS TO BE AN ISSUE WITH THE DATABASE CARRYING OVER DATA. PLEASE CLICK [HERE](https://repl.it/@CoolCoderSJ/Python-TheTutorial#main.py) AND FORK THE REPL. THEN U CAN RUN IT PROPERLY.
